...
from megalodon.configuration import ConfStore
...
ConfStore["mega200M"] = ModelConf(num_layers=12, model_dim=1024, num_heads=1, z_dim=256, value_dim=2048, ffn_hidden_dim=2560,
                                  chunk_size=2048, norm_num_groups=32)

ConfStore["mega1.3B"] = ModelConf(num_layers=24, model_dim=2048, num_heads=2, z_dim=512, value_dim=4096, ffn_hidden_dim=4864,
                                  chunk_size=2048, norm_num_groups=64)

ConfStore["mega1.3B_pg19"] = ModelConf(num_layers=24, model_dim=2048, num_heads=2, z_dim=512, value_dim=4096, ffn_hidden_dim=3584,
                                       chunk_size=2048, norm_num_groups=64, swiglu=True, scale_emb=True, share_emb=True)

ConfStore["mega7.1B"] = ModelConf(num_layers=32, model_dim=4096, num_heads=4, z_dim=1024, value_dim=8192, ffn_hidden_dim=11264,
                                  chunk_size=2048, norm_num_groups=64)

ConfStore["mega7.3B"] = ModelConf(num_layers=32, model_dim=4096, num_heads=4, z_dim=1024, value_dim=8192, ffn_hidden_dim=8192,
